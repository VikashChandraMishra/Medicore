                ...
                {calendarDays.map((day) => {
                    ...
                    return (
                        <div
                            ...
                            className={`relative min-h-28 border-b border-r border-gray-200 p-2 last:border-r-0 sm:min-h-32 ${canEditDay ? `cursor-pointer transition ${THEME.HOVER_BACKGROUND}` : ""} ${day.isPast
